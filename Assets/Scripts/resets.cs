...
public class resets : MonoBehaviour
{
    ...
    void GenerateRandomText()
    {
        if (randomText != null && randomTextOptions.Length > 0)
        {
            ...
            {
                case 0:
                    selectedText = randomTextOptions[0];
                    Debug.Log(0);
                    break;
                case 1:
                    selectedText = randomTextOptions[1];
                    Debug.Log(1);
                    break;
                case 2:
                    selectedText = randomTextOptions[2];
                    Debug.Log(2);
                    break;
                case 3:
                    selectedText = randomTextOptions[3];
                    Debug.Log(3);
                    break;
                case 4:
                    selectedText = randomTextOptions[4];
                    Debug.Log(4);
                    break;
            }
